...
ARG VITE_LOGTO_ENDPOINT=https://auth.cqaiclub.asia
ARG VITE_LOGTO_API_RESOURCE
ARG VITE_LOGTO_API_SCOPES=ai:invoke
ARG VITE_ACCOUNT_SERVICE_URL
ARG VITE_PROMPT_LIBRARY_URL
...
ENV VITE_LOGTO_API_SCOPES=$VITE_LOGTO_API_SCOPES
ENV VITE_ACCOUNT_SERVICE_URL=$VITE_ACCOUNT_SERVICE_URL
ENV VITE_PROMPT_LIBRARY_URL=$VITE_PROMPT_LIBRARY_URL
